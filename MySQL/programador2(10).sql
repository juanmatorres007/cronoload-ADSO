...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-07-2024 a las 01:23:49
...
CREATE TABLE `activity` (
  ...
  `state_acti` int(11) NOT NULL,
  `id_prog_acti` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `activity` (`id_auto_acti`, `name_acti`, `date_register_acti`, `state_acti`, `id_prog_acti`) VALUES
(2, 'Manejo TIC', '2024-07-05', 1, 1);
...
(11, 41, 478, 'Cr2 8a-40', 82),
(12, 54, 17, 'cll 2 avn 2', 83);
...
CREATE TABLE `competition` (
  ...
  `state_comp` int(11) NOT NULL,
  `id_acti_comp` int(11) NOT NULL,
  `id_area_comp` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `competition` (`id_auto_comp`, `name_comp`, `number_comp`, `date_register_comp`, `state_comp`, `id_acti_comp`, `id_area_comp`) VALUES
(3, 'PROGRAMAR', 12, '2024-07-05', 1, 2, 12);
...
(27, 'samesteban2005@gmail.com', 3003670090, 82),
(28, 'gMurcia@gmail.com', 32658484, 83);
...
INSERT INTO `events` (`id_auto_events`, `date_eve`, `id_user_eve`, `id_comp_eve`, `id_res_eve`, `id_cal_eve`) VALUES
(2, '2024-07-06', 83, 3, 1, 5),
(3, '2024-07-08', 83, 3, 2, 5),
(6, '2024-07-11', 83, 3, 1, 5);
...
INSERT INTO `phase` (`id_auto_pha`, `name_pha`, `date_register_pha`, `state_pha`, `id_res_pha`) VALUES
...
INSERT INTO `project` (`id_auto_proj`, `name_proj`, `number_proj`, `state_proj`, `register_date_proj`) VALUES
(3, 'HSFKF', 123, 1, '2024-04-30'),
(5, 'GHYIU', 1234, 1, '2024-07-02');
...
INSERT INTO `user` (`id_auto_user`, `name_user`, `lastname_user`, `type_id_user`, `number_id_user`, `photo_user`, `birth_user`, `id_gen_user`, `state_user`, `id_know_user`, `id_formation_lvl_user`) VALUES
(82, 'Samuel', 'Salazar', 1, 1, NULL, '2005-04-20', 1, 1, 12, 3),
(83, 'Gilberto', 'Murcia Ramos', 1, 21534548, NULL, '2024-07-03', 1, 1, 12, 3);
...
ALTER TABLE `activity`
  ...
  ADD KEY `id_auto_pha_acti` (`id_prog_acti`),
  ADD KEY `state_acti` (`state_acti`);
...
ALTER TABLE `competition`
  ...
  ADD KEY `id_area_comp` (`id_area_comp`),
  ADD KEY `state_comp` (`state_comp`);
...
ALTER TABLE `phase`
  ...
  ADD KEY `id_auto_project_pha` (`id_res_pha`),
  ADD KEY `id_res_pha` (`id_res_pha`);
...
ALTER TABLE `user`
  ...
  ADD UNIQUE KEY `number_id_user` (`number_id_user`),
...
--
ALTER TABLE `acceso`
  MODIFY `id_auto_acc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT de la tabla `activity`
--
ALTER TABLE `activity`
  MODIFY `id_auto_acti` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `address_u`
--
ALTER TABLE `address_u`
  MODIFY `id_auto_add` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `calendar`
--
ALTER TABLE `calendar`
  MODIFY `id_auto_cal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `competition`
--
ALTER TABLE `competition`
  MODIFY `id_auto_comp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `contact`
--
ALTER TABLE `contact`
  MODIFY `id_auto_con` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `events`
  MODIFY `id_auto_events` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `project`
  MODIFY `id_auto_proj` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `relation_rol_user`
--
ALTER TABLE `relation_rol_user`
  MODIFY `id_auto_relaru` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de la tabla `relation_user_file`
--
ALTER TABLE `relation_user_file`
  MODIFY `id_auto_reluf` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `user`
  MODIFY `id_auto_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT de la tabla `vinculation`
--
ALTER TABLE `vinculation`
  MODIFY `id_auto_vin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `activity`
  ADD CONSTRAINT `activity_ibfk_1` FOREIGN KEY (`id_prog_acti`) REFERENCES `phase` (`id_auto_pha`),
  ADD CONSTRAINT `activity_ibfk_2` FOREIGN KEY (`state_acti`) REFERENCES `states` (`id_auto_sta`);

--
-- Filtros para la tabla `address_u`
--
ALTER TABLE `address_u`
  ADD CONSTRAINT `address_u_ibfk_1` FOREIGN KEY (`department_add`) REFERENCES `departamentos` (`id_departamento`),
  ADD CONSTRAINT `address_u_ibfk_2` FOREIGN KEY (`municipality_add`) REFERENCES `municipios` (`id_municipio`),
  ADD CONSTRAINT `address_u_ibfk_3` FOREIGN KEY (`id_user_add`) REFERENCES `user` (`id_auto_user`);
...
--
ALTER TABLE `competition`
  ADD CONSTRAINT `competition_ibfk_1` FOREIGN KEY (`id_area_comp`) REFERENCES `knowledge_area` (`id_auto_know`),
  ADD CONSTRAINT `competition_ibfk_2` FOREIGN KEY (`state_comp`) REFERENCES `states` (`id_auto_sta`),
  ADD CONSTRAINT `competition_ibfk_3` FOREIGN KEY (`id_acti_comp`) REFERENCES `activity` (`id_auto_acti`);
...
ALTER TABLE `events`
  ...
  ADD CONSTRAINT `events_ibfk_2` FOREIGN KEY (`id_res_eve`) REFERENCES `result` (`id_auto_res`),
  ADD CONSTRAINT `events_ibfk_3` FOREIGN KEY (`id_comp_eve`) REFERENCES `competition` (`id_auto_comp`),
  ADD CONSTRAINT `events_ibfk_4` FOREIGN KEY (`id_user_eve`) REFERENCES `user` (`id_auto_user`);

--
-- Filtros para la tabla `ficha`
--
ALTER TABLE `ficha`
  ADD CONSTRAINT `ficha_ibfk_1` FOREIGN KEY (`id_proj_file`) REFERENCES `project` (`id_auto_proj`);
...
--
ALTER TABLE `relation_rol_user`
  ADD CONSTRAINT `relation_rol_user_ibfk_1` FOREIGN KEY (`id_rol_relaru`) REFERENCES `rol` (`id_auto_rol`),
  ADD CONSTRAINT `relation_rol_user_ibfk_2` FOREIGN KEY (`id_user_relaru`) REFERENCES `user` (`id_auto_user`);

--
-- Filtros para la tabla `relation_user_file`
--
ALTER TABLE `relation_user_file`
  ADD CONSTRAINT `relation_user_file_ibfk_1` FOREIGN KEY (`id_file_reluf`) REFERENCES `ficha` (`id_auto_fil`),
  ADD CONSTRAINT `relation_user_file_ibfk_2` FOREIGN KEY (`id_user_reluf`) REFERENCES `user` (`id_auto_user`);
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `user_ibfk_3` FOREIGN KEY (`id_know_user`) REFERENCES `knowledge_area` (`id_auto_know`),
  ADD CONSTRAINT `user_ibfk_4` FOREIGN KEY (`id_formation_lvl_user`) REFERENCES `formation_lvl` (`id_auto_flvl`),
  ADD CONSTRAINT `user_ibfk_5` FOREIGN KEY (`id_gen_user`) REFERENCES `genero` (`id_genero_auto`),
  ADD CONSTRAINT `user_ibfk_6` FOREIGN KEY (`type_id_user`) REFERENCES `type_id` (`id_idType_auto`);

--
-- Filtros para la tabla `vinculation`
--
ALTER TABLE `vinculation`
  ADD CONSTRAINT `vinculation_ibfk_1` FOREIGN KEY (`id_contractType_vin`) REFERENCES `contracts` (`id_auto_cont`),
  ADD CONSTRAINT `vinculation_ibfk_2` FOREIGN KEY (`id_user_vin`) REFERENCES `user` (`id_auto_user`);
COMMIT;
