...
--
ALTER TABLE `contracts`
  MODIFY `id_auto_cont` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `notification`
  ADD CONSTRAINT `notification_ibfk_1` FOREIGN KEY (`id_file_noti`) REFERENCES `ficha` (`id_auto_fil`);
...
ALTER TABLE `relation_user_file`
  ...
  ADD CONSTRAINT `relation_user_file_ibfk_2` FOREIGN KEY (`id_file_reluf`) REFERENCES `ficha` (`id_auto_fil`);
...
ALTER TABLE `vinculation`
  ...
  ADD CONSTRAINT `vinculation_ibfk_2` FOREIGN KEY (`id_contractType_vin`) REFERENCES `contracts` (`id_auto_cont`);
COMMIT;
